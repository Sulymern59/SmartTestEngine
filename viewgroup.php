...
<?php 
 if(!isset($_GET['vgid']) && $_GET['vgid']==NULL){
     ...
     $nt = new DateTime('now', new DateTimeZone('Europe/London'));
        ...
        <h3 style="width:500px;"><pre>User Information For This Group:</pre></h3><br>
          <table class="table table-bordered table-striped">
            ...
            <tr class="info">
              ...
              <td><a href="deleteuserfmgp.php?urgid=<?php echo $eachsid; ?>"><button class="btn" style="background-color: purple;color: white">Delete</button></a></td>
              <td><a href="adminresultsheet.php?resid=<?php echo $eachsid;?>&regpid=<?php echo $vgid;?>&tgtq=<?php echo $tgtq;?>"><button class="btn" style="background-color: purple;color: white">See Result</button></a></td>
            </tr>
            <?php } } ?>
            </tbody>             
          </table>
     ...
     <div class="row-fluid">
      <div class="span10 offset1 ">
        <h3 style="width: 300px;"><pre>Publish The Result:</pre></h3><br>
         <?php
            if($ch==""){
              echo "<button class='btn offset5' style='background-color: purple;'>Wait For Finishing Exam</button>";
            }else{ ?>
              <a href="publishresult.php?pgid=<?php echo $vgid; ?>"><button class='btn offset5' style="background-color: purple;color: white">Publish Result</button></a>
           <?php }
         ?>
       </div>
      </div>
