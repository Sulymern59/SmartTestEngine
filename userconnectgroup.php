 ...
 <section>
 	<div class="row-fluid">
      <div class="span8 offset3">
         ...
         <p><strong>2. </strong>You Must Get a Group ID from your tutor.</p>
      </div>
    </div>
 </section>
      ...
      <div class="span8 offset3">
		<form action="" method="POST">
		  ...
		  <div class="form-group hgad">
		    <label style="margin-right: 104px;">Tutor Id</label>
		  ...
		  <div class="form-group hgad">
		    <label style="margin-right: 104px;">Reg No.</label>
		  ...
		  <div class="form-group hgad">
		    <label style="margin-right: 76px;">Course code</label>
